...
@RestController
@RequestMapping("/api/websockets-jhi-kafka")
public class WebsocketsJhiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebsocketsJhiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebsocketsJhiKafkaResource(KafkaProperties kafkaProperties) {
