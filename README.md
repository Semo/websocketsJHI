...
To build the final jar and optimize the websocketsJHI application for production, run:
...
Then navigate to [http://localhost:9012](http://localhost:9012) in your browser.
